...
exports.codePushGradlePath = void 0;
/**
 ...
 */
function codePushGradlePath(relativePath) {
    const packageJson = `["node", "--print", "require.resolve('react-native-code-push/package.json')"].execute(null, rootDir).text.trim()`;
    return `new File(new File(${packageJson}).parentFile, "${relativePath}")`;
}
exports.codePushGradlePath = codePushGradlePath;
//# sourceMappingURL=codePushGradlePath.js.map